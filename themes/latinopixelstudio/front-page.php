    ...
    echo '<section class="position-relative" style="padding:100px 0;">';
        echo '<div class="container">';
            echo '<div class="row align-items-center">';
                ...
                echo '<h1 class="bold">Your Dedicated'; 
                echo '<div style="min-height:50px;">';

                echo '<span id="feature-text"></span>';
                ...
                // echo '<span class="txt-type" style="border-right:1px solid #777;" data-wait="1000" data-words=\'["Developer","Designer","Creator"]\'></span>';

                // echo '</div>';

                echo 'Developer</h1>';
                echo '<h2 class="h5">Surfing the Waves of WordPress Excellence: Your Reliable Partner for Stunning Websites!</h2>';
                echo '<p>As a proficient freelance WordPress developer, I am your reliable partner for bringing design visions to life. With a keen eye for detail and expert proficiency in WordPress, I transform design files into stunning, fully functional websites. From concept-inspired development to seamless collaboration in meetings, I\'m dedicated to delivering outstanding results that leave a lasting impression.</p>';
                echo '<a href="' . home_url() . '/portfolio/" target="_self" class="btn-main">View Portfolio</a>';
                echo '</div>';
